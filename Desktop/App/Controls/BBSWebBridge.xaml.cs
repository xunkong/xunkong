...
public sealed partial class BBSWebBridge : UserControl
{
    ...
    private readonly HttpClient _httpClient = ServiceProvider.GetService<HttpClient>()!;
    ...
    private HoyolabClient _hoyolabClient;
    ...
    [ObservableProperty]
    private GenshinRoleInfo _GenshinRole;
    partial void OnGenshinRoleChanged(GenshinRoleInfo value)
    {
    ...
    private async Task InitializeWebViewAsync()
    {
        try
        {
            ...
            await _hoyolabClient.UpdateDeviceFpAsync();
            await webview2.EnsureCoreWebView2Async();
            var coreWebView2 = webview2.CoreWebView2;
            coreWebView2.Settings.UserAgent = HoyolabClient.UAContent;
    ...
    public async Task LoadPageAsync(bool force = false)
    {
        try
        {
            ...
            if (coreWebView2.Source is "about:blank" || force)
            {
                ...
                const string url = "https://webstatic.mihoyo.com/app/community-game-records/?game_id=2";
    ...
    {
        cookieDic.Clear();
        var cookies = GenshinRole?.Cookie?.Split(';');
        if (cookies is null)
        {
            return;
        }
    ...
    private async Task CaptureScreenshotAsync()
    {
        ...
        {
            Logger.Error(ex, "capture screenshot");
    ...
    private async Task DownloadScreenshotAsync(string url)
    {
        ...
        {
            Logger.Error(ex, "download screenshot");
            Grid_Screenshot.Visibility = Visibility.Collapsed;
        }
    }
    ...
    private async Task SaveScreenshotAsync()
    {
        ...
        {
            Logger.Error(ex, "Save screenshot");
        }
    }
    ...
    private async Task CopyScreenshotAsync()
    {
        ...
        {
            Logger.Error(ex, "Copy screenshot");
        }
    }
    ...
    private JsResult? GetHttpRequestHeader(JsParam param)
    {
        return new()
        {
            ...
            {
                ["x-rpc-client_type"] = "5",
                ["x-rpc-app_version"] = HoyolabClient.AppVersion,
                ["x-rpc-device_fp"] = _hoyolabClient.DeviceFp,
                ["x-rpc-device_id"] = _hoyolabClient.DeviceId,
            },
        };
    }
    ...
    {
        string ApiSalt = "t0qEgfub6cvueAPgR5m9aQWWVciEer7v";
    ...
    {
        string ApiSalt2 = "xV8v4Qu54lUKrEYFZkJhB8cuOh9Asafs";
